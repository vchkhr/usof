            ...
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        @if($profile->profile_photo != null)
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <a href="{{ $profile->profileImage() }}" target="_blank">
                    ...
                    <div class="alert alert-danger mt-5" role="alert">
                        ...
                        <p>To delete the profile enter &nbsp;<code><strong>{{ $user->name }}</strong></code>&nbsp; and press "Delete Profile". This will delete all the data, including profile's information, questions, answers, likes and their materials, such as images.</p>
