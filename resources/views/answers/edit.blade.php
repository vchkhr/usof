    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="/answer/{{ $answer->id }}" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="description" type="text" class="form-control @error('description') is-invalid @enderror" name="description" value="{{ $answer['description'] }}" autocomplete="description">
                        ...
                        @if($answer['image'] != null)
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <img src="/storage/{{ $answer['image'] }}" style="max-width: 100px; border-radius: 5px;">
